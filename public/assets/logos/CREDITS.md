Retailer logos used as "available on" badges, linking directly to the real product listings.

- `amazon.png`: Amazon logo, recolored to solid white (alpha channel preserved exactly)
  from Wikimedia Commons ("Amazon 2024.svg"),
  https://commons.wikimedia.org/wiki/File:Amazon_2024.svg, for legibility directly on
  the site's dark background, with no boxed background behind it.
- `barnes-noble.png`: Barnes & Noble logo (2021 mark), recolored to solid white (alpha
